 ...
 * Данные (название, характеристики, фото) подставляются из карточки при генерации.
 */
...
/**
 * Синхронизация выбранных характеристик: старые поля сохраняем, новые из категории добавляем.
 * @param {object[]} modules
 * @param {Array<{ key: string, label: string, required?: boolean }>} available
 */
