      ...
      {formData.type === 'warehouse' && (
        <div className="col-12 mt-2">
          ...
          <div className="text-muted small mb-2">
            Отметьте рабочие дни. Снятая галочка = выходной. После cutoff поставщика
            в последний рабочий день перед выходными и в сами выходные заказы идут
            в одну закупку до отсечки в последний выходной; после неё — новая закупка.
          </div>
