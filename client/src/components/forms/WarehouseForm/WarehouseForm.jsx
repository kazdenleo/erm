      ...
      {formData.type === 'warehouse' && (
        <div className="col-12 mt-2">
          ...
          <div className="text-muted small mb-2">
            Отметьте рабочие дни. Снятая галочка = выходной. Заказы с одной датой
            приезда на склад (с учётом окон поставщика и наших выходных) идут в одну
            закупку: например Mikado после отсечки в четверг при выходных сб/вс —
            до воскресенья (приезд в понедельник). После этой отсечки — новая закупка.
          </div>
