...
const INSTALL_STEPS = [
  ...
  },
  {
    ...
    text: 'Откройте эту страницу заново. Если расширение спросит доступ — нажмите «Разрешить». В настройках расширения dttrade.ru должен быть в списке доверенных сайтов.',
  },
  {
