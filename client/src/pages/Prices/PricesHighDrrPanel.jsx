  ...
  return (
    <div className="prices-high-drr-panel">
      <p className="text-muted small mb-3">
        ...
        товар убирается из списка после синхронизации членства (каждые 2 часа или ночью), а
        минимальная цена пересчитывается и уходит на Ozon без ожидания ночного прогона. Вне
        кампаний реклама не входит в расчёт минимальной цены.
      </p>
